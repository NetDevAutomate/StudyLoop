...
class TestResolveHosts:
    def test_identifies_local_by_hostname(
        ...
        from studyloop.shared import _resolve_hosts
...
class TestGetHostIps:
    def test_dict_format(self) -> None:
        from studyloop.shared import _get_host_ips
...
class TestSyncStatus:
    ...
    def test_configured_with_reachable_remote(
        ...
        with patch("studyloop.shared.subprocess.run", return_value=mock_result):
            result = sync_status()

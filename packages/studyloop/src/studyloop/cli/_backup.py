...
def restore(backup_name: str | None, confirm: bool) -> None:
    ...
    if not backup_dir.exists() or not any(backup_dir.iterdir()):
        ...
        console.print("  Run [bold]studyloop backup[/bold] to create one.")
        return
    ...
    if backup_name is None:
        ...
        console.print("\n  Restore: [bold]studyloop restore <name> --confirm[/bold]")
        return
    ...
    if restored:
        ...
        console.print("  Run [bold]studyloop doctor[/bold] to verify.")
    else:

...
| | |
|---|---|
| 🎧 **[Listen to the Audio Overview](https://netdevautomate.github.io/Socratic-Study-Mentor/artefacts/)** | Two AI hosts discuss the project — great for commutes |
| 🎬 **[Watch the Video Overview](https://netdevautomate.github.io/Socratic-Study-Mentor/artefacts/#video)** | Visual walkthrough of architecture and concepts |
| 🖼️ **[View the Infographic](https://netdevautomate.github.io/Socratic-Study-Mentor/artefacts/#infographic)** | Architecture and flow at a glance |
| 📊 **[Browse the Slide Deck](https://netdevautomate.github.io/Socratic-Study-Mentor/artefacts/#slides)** | Presentation-ready project overview |

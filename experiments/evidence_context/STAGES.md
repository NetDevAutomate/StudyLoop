...
| 36 — Permission withdrawal and regrant | Can current source-bound receipt coverage distinguish erasure, quarantine and safe re-exposure? | pending | `permission_withdrawal/runner.py`; six-view standalone-wheel lesson, generation/crash/cascade tests and council arbitration. Operator reconciliation, real sync and managed restore remain open. |

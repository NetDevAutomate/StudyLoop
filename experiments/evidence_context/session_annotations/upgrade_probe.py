...
def main():
    ...
    if before_version != 38:
        raise ValueError("This Stage30 rehearsal expects a schema38 source copy")
    tables = [
        r[0]
    ...
    # This preservation fixture must not include deliberate deletion intent:
    # schema39 purges legacy annotation shadows of already-forgotten sessions.
    if conn.execute("SELECT 1 FROM context_tombstones LIMIT 1").fetchone():
        raise ValueError("Use an unretired schema38 fixture for the row-preservation rehearsal")

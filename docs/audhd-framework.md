...
!!! tip "Source"
    This is the docs-friendly version of `agents/shared/audhd-framework.md`.
...
!!! struggling "Anti-pattern"
    Starting with "The Strategy Pattern is a behavioural design pattern that..." — this is top-down. Start with code that has a problem, guide to discovering the pattern.
...
| State | Adaptation |
|-------|------------|
| anxious | Start with a familiar win |
| frustrated | Switch modality — diagram or code kata |
| flat | Body doubling — low demand, periodic check-ins |
| overwhelmed | Shorter chunks (5 min max), review only |
| shutdown | Gentle exit. No teaching. No productivity |
...
!!! energy-check "Never short-circuit this loop"
    The struggle IS the learning mechanism for the AuDHD brain. Giving the answer too early kills the dopamine reward.

---

## Parking Lot Pattern

When the learner goes tangential — don't dismiss it. AuDHD tangents are often genuine connections.

- "Interesting — parking that for later: **[topic]**. Back to [current topic]."
- Maintain a running list. Surface at end of session.
- If a parked item is actually relevant, bring it back.
...
- "What are you working on? How long do you want to go?"
- Brief check-ins. Don't break flow state.

### Async (low-energy / shutdown)

- "I'm here. Work at your own pace. I'll check in every 15 minutes."

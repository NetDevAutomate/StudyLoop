...
The project is a **pre-1.0 pre-release**. Six mentor harnesses are first-party: Kiro CLI, Codex, Claude
Code and pi are core; OpenCode and Grok Build are preview. Everything else is out of scope until an issue
defines it.
